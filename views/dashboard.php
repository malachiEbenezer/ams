...
<body>
    ...
    <div class="contentDash">
        <div class="contentDash-1">
            <div class="regStudent">
                <div class="newReg">
                    <h4 class="newRegHeader">Newly Registered Students</h4>
                </div>
                <div class="totalReg">
                    <h4 class="totalRegHeader">No. of Registered Students</h4>
                </div>
            </div>
            <div class="regSchool">
        ...
        <div class="contentDash-2">

        </div>
        <div class="contentDash-3">
