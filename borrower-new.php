...
<head>
    ...
    <link rel="stylesheet" href="/ams/css/borrower.css?v=<?php echo time(); ?>" type="text/css" />
    ...
    <div class="fill">
        <div class="menu">
            ...
            <div class="menutabs">
                ...
                <div class="menulinks">
                    <a href="/ams/home.php" class="home" id="home">
                        ...
                        Home</a>
                    <a href="/ams/dashboard.php" class="dashboard" id="dashboard">
                        ...
                        Dashboard</a>
                    <a href="/ams/register-rec.php" class="register" id="register">
                        ...
                        Register</a>
                    <a href="/ams/borrower-exist.php" class="borrowers" id="borrowers">
                        ...
                        Borrowers</a>
                    <a href="/ams/report-eng.php" class="report" id="report">
